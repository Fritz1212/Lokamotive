...
GraphBuilder.buildGraph()
  .then((graph) => {
    const commuterNodes = Object.values(graph.nodes).filter(node => node.type === "Commuter Line");
    console.log(commuterNodes);
  })
  .catch((error) => console.error("❌ Error building graph:", error));

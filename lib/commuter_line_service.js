...
/**
 * Memproses data jadwal Commuter Line untuk menghasilkan daftar node stasiun.
 *
 * Fungsi ini melakukan iterasi pada data jadwal, memvalidasi dan mengekstrak informasi stasiun asal dan tujuan, 
 * serta memproses koordinat stasiun secara paralel. Node stasiun yang diproses kemudian disimpan dalam objek `nodesMap`
 * dengan batas maksimum jumlah stasiun (MAX_STATIONS). Hanya stasiun dengan nama yang mengandung kata 'Jabodetabek' 
 * yang dipertimbangkan.
 *
 * @created 2024-12-01
 * @author Jane Doe
 * @async
 * @param {Object[]} scheduleData - Array objek data jadwal yang berisi informasi masing-masing perjalanan.
 * @return {Promise<Object[]>} - Promise yang mengembalikan array node stasiun yang sudah diproses.
 */
...
/**
 * Memproses data stasiun untuk mendapatkan koordinat.
 *
 * Fungsi ini mengecek apakah nama stasiun mengandung kata 'Jabodetabek'. Jika koordinat sudah tersedia 
 * (existingLat dan existingLng), maka fungsi akan mengembalikannya setelah dikonversi menjadi tipe number.
 * Jika koordinat tidak tersedia, fungsi akan memanggil fungsi geocoding (getCoordinatesForStation) untuk 
 * mendapatkan koordinat berdasarkan nama stasiun.
 *
 * @created 2024-12-01
 * @author Jane Doe
 * @async
 * @param {string} id - ID unik stasiun.
 * @param {string} name - Nama stasiun.
 * @param {string|number} existingLat - Latitude stasiun (bisa berupa string atau number).
 * @param {string|number} existingLng - Longitude stasiun (bisa berupa string atau number).
 * @return {Promise<Object|null>} - Promise yang mengembalikan objek koordinat dengan properti `lat` dan `lng`, atau null jika stasiun tidak valid.
 */
